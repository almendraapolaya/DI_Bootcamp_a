...
class Family(Person):
    ...
    def born(self, first_name, age):
        ...
        print(f"{first_name} {self.last_name} has been added to the family!")
...
my_family.born("Alme", 25)
my_family.born("Alicia", 21)
my_family.born("Bobby", 12)

my_family.check_majority("Alme") 
my_family.check_majority("Bobby")   
