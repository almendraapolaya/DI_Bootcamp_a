...
#   add_animals -> Before the bonus task:
...
#   After bonus task:
    ...
    def get_animal_types(self):                            # Bonus Expanded The Farm:
        return sorted(self.animals.keys())
    
    def get_short_info(self):
        animal_names = self.get_animal_types()
        plural_list = []
        ...
        all_animals = ", ".join(plural_list)

        return f"{self.name}'s farm has {all_animals}"
